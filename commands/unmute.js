...
export default async function unmuteCommand(message, client) {
  ...
  try {
    ...
    return client.sendMessage(chat, { text: "> 🔓 *𝐆𝐑𝐎𝐔𝐏𝐄 𝐎𝐔𝐕𝐄𝐑𝐓.* 𝐓𝐎𝐔𝐒 𝐋𝐄𝐒 𝐏𝐀𝐑𝐓𝐈𝐂𝐈𝐏𝐀𝐍𝐓𝐒 𝐏𝐄𝐔𝐕𝐄𝐍𝐓 𝐄𝐍𝐕𝐎𝐘𝐄́𝐒 𝐃𝐄𝐒 𝐌𝐄𝐒𝐒𝐀𝐆𝐄𝐒.", ...channelInfo }, { quoted: fakeQuoted });
  } catch (err) {
